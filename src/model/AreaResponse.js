...
class AreaResponse {
     ...
     */
    constructor(area, nominatorCount, candidateCount, nominators) { 
        
        AreaResponse.initialize(this, area, nominatorCount, candidateCount, nominators);
    }
     ...
     */
    static initialize(obj, area, nominatorCount, candidateCount, nominators) { 
        obj['area'] = area;
